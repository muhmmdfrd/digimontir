...
@section('content')
    ...
    <h1 class="text-2xl font-semibold mb-6">Add Role</h1>
    <form action="{{ route('admin.roles.store') }}" method="POST" class="max-w-md space-y-4">
        @csrf
        <div>
        ...
        <button type="submit" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium">Create Role</button>
    </form>
@endsection
